...
The actual RottenPotatoes starter app you will use is at: [rottenpotatoes-rails-intro](https://github.tamu.edu/jeffhuang/software-engineering-hw/tree/master/ruby-on-rails/rottenpotatoes-rails-intro/).  
