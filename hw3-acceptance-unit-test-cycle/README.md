...
Once you have a clone of this repo at your local machine or C9 workspace:

1) Change into the rottenpotatoes directory: `cd hw3-acceptance-unit-test-cycle/rottenpotatoes`  
